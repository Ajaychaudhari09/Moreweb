  ...
  return (
    <div className="container mx-auto px-4 max-w-6xl">
      ...
      <section className="text-center mb-14">
        {/* Title and description moved to server page for SEO */}
        ...
        <div className="relative max-w-lg mx-auto mt-6">
          ...
          <Input
            ...
            className="pl-12 py-6 text-lg rounded-full shadow-lg border-border bg-card text-foreground focus-visible:ring-primary"
          />
        </div>
      </section>
